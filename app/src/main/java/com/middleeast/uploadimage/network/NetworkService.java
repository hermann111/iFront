...
package com.middleeast.uploadimage.network;

import android.app.IntentService;
import android.content.Intent;
import android.net.Uri;

import com.middleeast.uploadimage.Util;
import com.middleeast.uploadimage.models.DownloadModel;
import com.middleeast.uploadimage.models.TransferModel;
import com.middleeast.uploadimage.models.UploadModel;
...
public class NetworkService extends IntentService {
    ...
    //Added by Harmanjeet on May 10, 2015
    public static final String FILE_NAME_TO_UPLOAD = "mfileName";
        ...
        if (intent != null && intent.getAction() != null) {
            if (intent.getAction().equals(Intent.ACTION_GET_CONTENT) &&
                ...
                download(intent.getStringArrayExtra(S3_KEYS_EXTRA));
                    ...
                    intent.getData() != null) {
                upload(intent.getData(), intent.getStringExtra(FILE_NAME_TO_UPLOAD));
