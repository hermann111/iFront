...
package com.middleeast.uploadimage.models;
...
import com.middleeast.uploadimage.Constants;
    ...
    public void upload() {
        ...
        if (mFile != null) {
            try {
                ...
                {
                    if(!super.getFileName().contains("."))
                        mExtension=super.getFileName() + "."+ mExtension;
                    else
                        mExtension=super.getFileName();
                }

                mUpload = getTransferManager().upload(
                        Constants.BUCKET_NAME.toLowerCase(),
