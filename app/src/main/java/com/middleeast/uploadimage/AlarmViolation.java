...
public class AlarmViolation extends Activity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.alarm_violation);

        pd = new TransparentProgressDialog(AlarmViolation.this, R.drawable.loader_green);
    ...
    public boolean onOptionsItemSelected(MenuItem item) {
        ...
        htmlBuilder.append("<title>Demystifying Email Design</title>");
        htmlBuilder.append("<meta name=\"viewport\" content=\"width=device-width, initial-scale=1.0\"/>");
        htmlBuilder.append("</head>");
        htmlBuilder.append("<body style=\"margin: 0; padding: 0;\">");
        htmlBuilder.append("<table border=\"1\" cellpadding=\"0\" cellspacing=\"0\" width=\"100%\">");
        htmlBuilder.append("<tr>");
        htmlBuilder.append("<td>");
        htmlBuilder.append("<table align=\"center\" border=\"1\" cellpadding=\"0\" cellspacing=\"0\" width=\"600\" style=\"border-collapse: collapse;\">");
        htmlBuilder.append("<tr>");
        htmlBuilder.append("<td align=\"center\" bgcolor=\"#70bbd9\" style=\"padding: 40px 0 30px 0;\">");
        htmlBuilder.append("<img src=\"images/h1.gif\" alt=\"Creating Email Magic\" width=\"300\" height=\"230\" style=\"display: block;\" />");
        htmlBuilder.append("</td>");
        htmlBuilder.append("</tr>");
        htmlBuilder.append("<tr>");
        htmlBuilder.append("<td align=\"center\" bgcolor=\"#70bbd9\" style=\"padding: 40px 0 30px 0;\">");
        ...
        htmlBuilder.append("</tr>");
        htmlBuilder.append("<tr>");
        htmlBuilder.append("<td bgcolor=\"#ffffff\" style=\"padding: 40px 30px 40px 30px;\">");
        htmlBuilder.append("<table border=\"1\" cellpadding=\"0\" cellspacing=\"0\" width=\"100%\">");
        htmlBuilder.append("<tr>");
        htmlBuilder.append("<td>");
        htmlBuilder.append("Lorem ipsum dolor sit amet!");
        htmlBuilder.append("</td>");
        htmlBuilder.append("</tr>");
        htmlBuilder.append("<tr>");
        htmlBuilder.append("<td style=\"padding: 20px 0 30px 0;\">");
        htmlBuilder.append("Lorem ipsum dolor sit amet, consectetur adipiscing elit. In tempus adipiscing felis, sit amet blandit ipsum volutpat sed. Morbi porttitor, eget accumsan dictum, nisi libero ultricies ipsum, in posuere mauris neque at erat.");
        htmlBuilder.append("</td>");
        htmlBuilder.append("</tr>");
        htmlBuilder.append("<tr>");
        htmlBuilder.append("<td>");
        htmlBuilder.append("<table border=\"1\" cellpadding=\"0\" cellspacing=\"0\" width=\"100%\">");
        htmlBuilder.append("<tr>");
        htmlBuilder.append("<td width=\"260\" valign=\"top\">");
        htmlBuilder.append("<table border=\"1\" cellpadding=\"0\" cellspacing=\"0\" width=\"100%\">");
        htmlBuilder.append("<tr>");
        htmlBuilder.append("<td>");
        htmlBuilder.append("<img src=\"images/left.gif\" alt=\"\" width=\"100%\" height=\"140\" style=\"display: block;\" />");
        htmlBuilder.append("</td>");
        htmlBuilder.append("</tr>");
        htmlBuilder.append("<tr>");
        htmlBuilder.append("<td style=\"padding: 25px 0 0 0;\">");
        htmlBuilder.append("Lorem ipsum dolor sit amet, consectetur adipiscing elit. In tempus adipiscing felis, sit amet blandit ipsum volutpat sed. Morbi porttitor, eget accumsan dictum, nisi libero ultricies ipsum, in posuere mauris neque at erat.");
        htmlBuilder.append("</td>");
        htmlBuilder.append("</tr>");
        htmlBuilder.append("</table>");
        htmlBuilder.append("</td>");
        htmlBuilder.append("<td style=\"font-size: 0; line-height: 0;\" width=\"20\">");
        htmlBuilder.append("&nbsp;");
        htmlBuilder.append("</td>");
        htmlBuilder.append("<td width=\"260\" valign=\"top\">");
        htmlBuilder.append("<table border=\"1\" cellpadding=\"0\" cellspacing=\"0\" width=\"100%\">");
        htmlBuilder.append("<tr>");
        htmlBuilder.append("<td>");
        htmlBuilder.append("<img src=\"images/right.gif\" alt=\"\" width=\"100%\" height=\"140\" style=\"display: block;\" />");
        htmlBuilder.append("</td>");
        htmlBuilder.append("</tr>");
        htmlBuilder.append("<tr>");
        htmlBuilder.append("<td style=\"padding: 25px 0 0 0;\">");
        ...
        htmlBuilder.append("</tr>");
        htmlBuilder.append("<tr>");
        htmlBuilder.append("<td bgcolor=\"#ee4c50\" style=\"padding: 30px 30px 30px 30px;\">");
        htmlBuilder.append("<table border=\"1\" cellpadding=\"0\" cellspacing=\"0\" width=\"100%\">");
        htmlBuilder.append("<td width=\"75%\">");
        htmlBuilder.append("&reg; Someone, somewhere 2013<br/>");
        htmlBuilder.append("Unsubscribe to this newsletter instantly");
        htmlBuilder.append("</td>");
        htmlBuilder.append("<td align=\"right\">");
        htmlBuilder.append("<table border=\"0\" cellpadding=\"0\" cellspacing=\"0\">");
        htmlBuilder.append("<tr>");
        htmlBuilder.append("<td>");
        htmlBuilder.append("<a href=\"http://www.twitter.com/\">");
        htmlBuilder.append("<img src=\"images/tw.gif\" alt=\"Twitter\" width=\"38\" height=\"38\" style=\"display: block;\" border=\"0\" />");
        htmlBuilder.append("</a>");
        htmlBuilder.append("</td>");
        htmlBuilder.append("<td style=\"font-size: 0; line-height: 0;\" width=\"20\">&nbsp;</td>");
        htmlBuilder.append("<td>");
        htmlBuilder.append("<a href=\"http://www.twitter.com/\">");
        htmlBuilder.append("<img src=\"images/fb.gif\" alt=\"Facebook\" width=\"38\" height=\"38\" style=\"display: block;\" border=\"0\" />");
        htmlBuilder.append("</a>");
        htmlBuilder.append("</td>");
        htmlBuilder.append("</tr>");
        htmlBuilder.append("</table>");
        ...
        switch (item.getItemId()) {
            ...
            case android.R.id.home:
                if(this.getLocalClassName().equals("AlarmViolation")) {
            ...
            case R.id.action_email:
                ...
                new SendMailTask(AlarmViolation.this).execute("hermann@hermannsoftware.com", "Satwant@111", email, "MESEC - fine system", "Hello This is a test automated mail from MESEC fine system");
                return true;
    ...
    private String writeXml(){
        ...
        String edtext_notice_period=edtext_notice_period_line1.getText()+" "+edtext_notice_period_line2.getText()+" "+edtext_notice_period_line2_value.getText()+" "+edtext_notice_period_line2_next.getText()+" "+edtext_notice_period_line3.getText();
