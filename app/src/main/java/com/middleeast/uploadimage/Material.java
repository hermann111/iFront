...
public class Material extends Activity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        pd = new TransparentProgressDialog(Material.this, R.drawable.loader_green);
    ...
    public boolean onOptionsItemSelected(MenuItem item) {
        switch (item.getItemId()) {
            ...
            case R.id.action_email:
                ...
                new SendMailTask(Material.this).execute("hermann@hermannsoftware.com", "Satwant@111", email, "MESEC - fine system", "Hello This is a test automated mail from MESEC fine system");
                return true;
