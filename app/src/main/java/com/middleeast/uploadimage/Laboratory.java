...
public class Laboratory extends Activity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        pd = new TransparentProgressDialog(Laboratory.this, R.drawable.loader_green);
    ...
    public boolean onOptionsItemSelected(MenuItem item) {
        switch (item.getItemId()) {
            ...
            case android.R.id.home:
                if(this.getLocalClassName().equals("Laboratory")) {
            ...
            case R.id.action_email:
                ...
                new SendMailTask(Laboratory.this).execute("hermann@hermannsoftware.com", "Satwant@111", email, "MESEC - fine system", "Hello This is a test automated mail from MESEC fine system");
                return true;
