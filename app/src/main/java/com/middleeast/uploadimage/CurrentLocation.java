 ...
 */
public class CurrentLocation extends Activity implements OnMapReadyCallback, ConnectionCallbacks, OnConnectionFailedListener {

    MapFragment mapFragment;
    GoogleMap mMap;

    private static final LatLng OMAN_MUSCAT = new LatLng(23.6100,58.5400);
    private static final LatLng INDIA_NEW_DELHI = new LatLng(28.6139, 77.2090);
