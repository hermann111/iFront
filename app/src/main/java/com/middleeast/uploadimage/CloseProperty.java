...
public class CloseProperty extends Activity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.close_property);

        pd = new TransparentProgressDialog(CloseProperty.this, R.drawable.loader_green);
    ...
    public boolean onOptionsItemSelected(MenuItem item) {
        switch (item.getItemId()) {
            ...
            case android.R.id.home:
                if(this.getLocalClassName().equals("CloseProperty")) {
            ...
            case R.id.action_email:
                ...
                new SendMailTask(CloseProperty.this).execute("hermann@hermannsoftware.com", "Satwant@111", email, "MESEC - fine system", "Hello This is a test automated mail from MESEC fine system");
                return true;
    ...
    private String writeXml(){
        ...
        TextView edtext_notice_period_line1=(TextView)findViewById(R.id.txt_close_property_notice_line1);
        TextView edtext_notice_period_line2=(TextView)findViewById(R.id.txt_close_property_notice_line2);
        EditText edtext_notice_period_line1_value=(EditText)findViewById(R.id.txt_close_property_notice_line1_value);
       // TextView edtext_notice_period_line2_next=(TextView)findViewById(R.id.edtext_notice_period_line2_next);
        ...
        String edtext_notice_period=edtext_notice_period_line1.getText()+" "+edtext_notice_period_line1_value.getText()+" "+edtext_notice_period_line2.getText();
